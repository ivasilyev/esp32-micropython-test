class BoilerPlate:
    ...
    CMRmap = [[0, 0, 0], [38, 38, 128], [76, 38, 191], [153, 51, 128], [255, 64, 38], [230, 128, 0], [230, 191, 26], [230, 230, 128], [255, 255, 255]]
    ...
    bone = [[0, 0, 0], [0, 81, 113], [166, 198, 190], [255, 255, 255]]
    cool = [[0, 255, 255], [255, 0, 255]]
    copper = [[0, 0, 0], [255, 161, 103], [255, 199, 127]]
    gist_rainbow = [[255, 0, 41], [255, 0, 0], [255, 255, 0], [0, 255, 0], [0, 255, 255], [0, 0, 255], [255, 0, 255], [255, 0, 191]]
    gist_stern = [[0, 0, 0], [255, 0, 0], [7, 0, 0], [14, 0, 255], [187, 187, 0], [255, 255, 255]]
    gray = [[0, 0, 0], [255, 255, 255]]
    hot = [[11, 0, 0], [255, 0, 0], [190, 255, 0], [255, 255, 255]]
    hsv = [[255, 0, 0], [255, 239, 0], [247, 255, 0], [8, 487, 0], [0, 175, 16], [0, 255, 255], [0, 16, 335], [8, 0, 207], [247, 0, 255], [255, 0, 239], [255, 0, 24]]
    jet = [[0, 0, 128], [0, 0, 255], [0, 0, 290], [0, 231, 255], [0, 238, 262], [0, 255, 281], [247, 255, 0], [251, 259, 0], [255, 263, 0], [255, 0, 0], [261, 0, 0], [128, 0, 0]]
    nipy_spectral = [[0, 0, 0], [119, 0, 136], [136, 0, 153], [0, 0, 170], [0, 0, 221], [0, 119, 221], [0, 153, 221], [0, 170, 170], [0, 170, 136], [0, 153, 0], [0, 187, 0], [0, 221, 0], [0, 255, 0], [187, 255, 0], [238, 238, 0], [255, 204, 0], [255, 153, 0], [255, 0, 0], [221, 0, 0], [204, 0, 0], [204, 204, 204]]
    ...
    terrain = [[51, 51, 153], [0, 153, 255], [0, 204, 102], [255, 255, 153], [128, 92, 84], [255, 255, 255]]
    winter = [[0, 0, 255], [0, 255, 128]]
    wistia = [[228, 255, 122], [255, 232, 26], [255, 189, 0], [255, 160, 0], [252, 127, 0]]
